...
nltk.download('stopwords', download_dir='C:/Users/Dell/nltk_data')
...
def run():
    ...
    activities = ["User", "About", "Admin", "Feedback"]
    choice = st.sidebar.selectbox("Select an option to explore more:", activities)
